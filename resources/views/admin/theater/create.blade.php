  ...
  <div class="container">
    <div class="row">
      <div class="col-md-8 mx-auto">
        <h2>劇場登録</h2>
        <form action="{{ action('Admin\TheaterController@create') }}" method="post" enctype="multipart/form-data">
          ...
          <div class="form-group row">
            ...
            <div class="col-md-10">
              <textarea class="form-control" name="address" rows="20">{{ old('address') }}</textarea>
            </div>
          </div>
          <div class="form-group row">
